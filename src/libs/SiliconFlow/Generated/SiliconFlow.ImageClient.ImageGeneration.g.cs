            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 504)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_504 = global::System.Text.Json.JsonSerializer.Deserialize<string?>(__content_504, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_504 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::SiliconFlow.ImagesGenerationResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::SiliconFlow.ImagesGenerationResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
