...
namespace SiliconFlow.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "SiliconFlow.CLI";
    private const string UserSecretApiKeyName = "SILICONFLOW_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"SILICONFLOW_API_KEY"];
    private const string CredentialFileDirectoryName = ".silicon-flow";

    public static async global::System.Threading.Tasks.Task<global::SiliconFlow.SiliconFlowClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::SiliconFlow.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::SiliconFlow.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::SiliconFlow.SiliconFlowClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::SiliconFlow.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::SiliconFlow.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::SiliconFlow.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::SiliconFlow.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("SILICONFLOW_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::SiliconFlow.ApiException exception)
    {
        var builder = new StringBuilder();
