...
internal static class CliRuntime
{
    ...
    public static async Task<global::SiliconFlow.SiliconFlowClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::SiliconFlow.ApiException exception)
    {
        var builder = new StringBuilder();
